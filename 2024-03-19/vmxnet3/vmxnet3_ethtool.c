...
vmxnet3_tq_dev_stats[] = {
	/* description,         offset */
#ifdef MIKROTIK_STATS
	{ "tx unicast",	 offsetof(struct UPT1_TxStats, ucastPktsTxOK) },
	{ "tx multicast",offsetof(struct UPT1_TxStats, mcastPktsTxOK) },
	{ "tx broadcast",offsetof(struct UPT1_TxStats, bcastPktsTxOK) },
	{ "tx drop",     offsetof(struct UPT1_TxStats, pktsTxDiscard) },
#else
	{ "Tx Queue#",        0 },
...
#ifdef MIKROTIK_STATS
	{ "rx unicast",     offsetof(struct UPT1_RxStats, ucastPktsRxOK) },
	{ "rx multicast",   offsetof(struct UPT1_RxStats, mcastPktsRxOK) },
	{ "rx broadcast",   offsetof(struct UPT1_RxStats, bcastPktsRxOK) },
	{ "rx error events",offsetof(struct UPT1_RxStats, pktsRxError) },
#else
	{ "Rx Queue#",        0 },
...
vmxnet3_rq_driver_stats[] = {
	/* description,         offset */
#ifdef MIKROTIK_STATS
	{ "rx drop",    offsetof(struct vmxnet3_rq_driver_stats, drop_total) },
	{ "rx fcs err", offsetof(struct vmxnet3_rq_driver_stats, drop_fcs) },
#else
