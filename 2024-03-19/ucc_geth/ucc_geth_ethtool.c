...
static int
uec_get_link_ksettings(struct net_device *netdev,
...
static int
uec_set_link_ksettings(struct net_device *netdev,
                       ...
                       struct ethtool_drvinfo *drvinfo)
{
	...
	sprintf(drvinfo->bus_info, "QUICC ENGINE %d", ugeth->ug_info->uf_info.ucc_num);
...
static const struct ethtool_ops uec_ethtool_ops = {
	.get_link_ksettings     = uec_get_link_ksettings,
	.set_link_ksettings     = uec_set_link_ksettings,
