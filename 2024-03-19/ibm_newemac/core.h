...
#define CONFIG_IBM_NEW_EMAC_RXB 256
#define CONFIG_IBM_NEW_EMAC_TXB 256
#define CONFIG_IBM_NEW_EMAC_POLL_WEIGHT 64
#define CONFIG_IBM_NEW_EMAC_RX_COPY_THRESHOLD 0
//#define CONFIG_IBM_NEW_EMAC_DEBUG 1
#define CONFIG_IBM_NEW_EMAC_ZMII y
#define CONFIG_IBM_NEW_EMAC_RGMII y
#define CONFIG_IBM_NEW_EMAC_TAH y
#define CONFIG_IBM_NEW_EMAC_EMAC4 y
...
{
	return EMAC_DMA_ALIGN(mal_rx_size(mtu + EMAC_MTU_OVERHEAD + 2));
}
...
static const struct eth_stat_item eth_stat_items_ibm_newemac[] = {
    { 0, ETH_STATS_DRIVER_RX_PACKET, NULL },
    { 0, ETH_STATS_DRIVER_RX_BYTE, NULL },
    { 0, ETH_STATS_DRIVER_TX_PACKET, NULL },
    { 0, ETH_STATS_DRIVER_TX_BYTE, NULL },
    { 0, -1, "rx packet csum" },
    { 0, -1, "tx packet csum" },

    { 0, -1, "tx undo" },

    { 0, -1, "rx dropped stack" },
    { 0, -1, "rx dropped oom" },
    { 0, -1, "rx dropped error" },
    { 0, -1, "rx dropped resize" },
    { 0, -1, "rx dropped mtu" },
    { 0, -1, "rx stopped" },

    { 0, -1, "rx bd error" },
    { 0, ETH_STATS_RX_OVERRUN, NULL },
    { 0, -1, "rx bd bad packet" },
    { 0, -1, "rx bd runt" },
    { 0, ETH_STATS_RX_TOO_SHORT, NULL },
    { 0, ETH_STATS_RX_ALIGN_ERR, NULL },
    { 0, ETH_STATS_RX_FCS_ERR, NULL },
    { 0, ETH_STATS_RX_TOO_LONG, NULL },
    { 0, -1, "rx bd out of range" },
    { 0, -1, "rx bd in range" },
    { 0, -1, "rx irq parity" },
    { 0, -1, "rx irq fifo overrun" },
    { 0, -1, "rx irq overrun" },
    { 0, -1, "rx irq bad packet" },
    { 0, -1, "rx irq runt packet" },
    { 0, -1, "rx irq short event" },
    { 0, -1, "rx irq alignment error" },
    { 0, -1, "rx irq bad fcs" },
    { 0, -1, "rx irq too long" },
    { 0, -1, "rx irq out of range" },
    { 0, -1, "rx irq in range" },

    { 0, -1, "tx dropped" },
    { 0, -1, "tx bd error" },
    { 0, ETH_STATS_TX_FCS_ERR, NULL },
    { 0, -1, "tx bd carrier loss" },
    { 0, ETH_STATS_TX_EXCESSIVE_DEFERRED, NULL },
    { 0, ETH_STATS_TX_EXCESSIVE_COL, NULL },
    { 0, ETH_STATS_TX_LATE_COL, NULL },
    { 0, ETH_STATS_TX_MULTI_COL, NULL },
    { 0, ETH_STATS_TX_SINGLE_COL, NULL },
...
#define EMAC_ETHTOOL_STATS_COUNT (sizeof(struct emac_stats) / sizeof(u64))
...
//#define STATS
#ifdef STATS
#define STATS_DIST_COUNT 3
#define STATS_DIST_GRAN 10
